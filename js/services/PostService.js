app.factory("PostService", function () {
  var posts = [
    ...
    },
    {
      ...
      excerpt:
        "Breathtaking views, crisp mountain air, and the thrill of hiking some of the most beautiful trails in Europe.",
      content:
